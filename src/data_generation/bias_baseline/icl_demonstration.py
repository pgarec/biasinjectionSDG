...
def main():
    ...
    parser.add_argument("--experiments-path", type=str, default="./src/configs/experiments/bias_baseline/exp_icl_demonstration.yaml", help="Path to the experiments YAML file")
