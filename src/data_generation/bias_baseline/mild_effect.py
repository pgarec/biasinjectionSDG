...
def main():
    ...
    parser.add_argument("--experiments-path", type=str, default="./src/configs/experiments/bias_baseline/exp_mild_effect.yaml", help="Path to the experiments YAML file")
    ...
    cfg_sdg['prompt_id'] = "bias_llms"
    cfg_sdg["icl_records"] = 80
    cfg_general["task"] = "adult"
    cfg_general["database"] = "adult_dataset"
    args.experiments_path = "./src/configs/experiments/bias_baseline/exp_mild_effect.yaml"
